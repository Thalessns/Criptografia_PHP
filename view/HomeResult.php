    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <form action="index.php?method=startAction" method="POST">
                ...
                <input type="text" name="iText" id="txt" value="<?php echo $text; ?>" placeholder="Insert the text">
                <br>
        ...
        <!-- Row to separate the contents / Linha para separar os conteúdos -->
        <hr style="color: rgb(255, 204, 0); width: 65%;">
        <!-- Div result has the results of the encrypt / A div result tem os resultados da criptografia -->
        <div id="result">
            <!-- Printing the results / Printando os resultados -->
            <?php echo "'$text' <div id='type'> $type </div> $result"; ?>
        </div>
        <!-- Row to separate the contents / Linha para separar os conteúdos -->
        <hr style="color: rgb(255, 204, 0); width: 65%;">
